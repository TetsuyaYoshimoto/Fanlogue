  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-r from-blue-400 to-indigo-400 rounded-full opacity-20 animate-float"
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300">イベント体験をもっと楽しく、もっと特別に</p>
        </div>

        {/* 認証フォーム */}
        <Card className="glass border-0 shadow-2xl">
          <CardHeader className="text-center pb-4">
            <CardTitle className="text-2xl font-bold text-gray-800 dark:text-gray-200">アカウント</CardTitle>
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input id="email" type="email" placeholder="your@email.com" className="pl-10 h-12" required />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <label className="flex items-center space-x-2 cursor-pointer">
                      ...
                      <span className="text-gray-600 dark:text-gray-400">ログイン状態を保持</span>
                    </label>
                    <Link
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input id="username" type="text" placeholder="ユーザー名を入力" className="pl-10 h-12" required />
                    </div>
                  </div>
                  ...
                  <div className="text-sm">
                    <label className="flex items-start space-x-2 cursor-pointer">
                      ...
                      <span className="text-gray-600 dark:text-gray-400">
                        <Link href="/terms" className="text-indigo-600 hover:text-indigo-700 dark:text-indigo-400">
                          利用規約
                        </Link>
                        および
                        <Link href="/privacy" className="text-indigo-600 hover:text-indigo-700 dark:text-indigo-400">
                          プライバシーポリシー
                        </Link>
                        に同意します
                      </span>
